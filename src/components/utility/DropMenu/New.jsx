...
function MyPopover() {
  return (
    <div className=" z-40 top-16 w-full max-w-sm px-4">
      <Popover className="relative">
        {({ open }) => (
          <>
            ...
            >
              <Popover.Panel className="absolute left-1/2  mt-3 w-screen max-w-sm -translate-x-1/2  z-30 transform px-4 sm:px-0 lg:max-w-3xl">
                <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black/5">
                  <div className="relative z-40 grid gap-8 bg-white p-7 lg:grid-cols-2">
                    {solutions.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
